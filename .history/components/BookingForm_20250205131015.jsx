...
const BookingForm = () => {
  ...
  // useTransition hook for handling UI transitions (e.g., form submission)
  ...
  // Final submission handler using Next.js 15 navigation and useTransition
  const onSubmit = (data) => {
    console.log("Booking submitted:", data);
    startTransition(() => {
      // After submission, redirect the user to a confirmation page
      router.push("/thank-you");
    });
  };

  // Render form content for each step using HeroUI components
        ...
        return (
          <div className="space-y-4">
            ...
            <Controller
              ...
              name="shipmentDate"
              render={({ field, fieldState: { error } }) => {
                // Convert field.value to a Date if it isn’t already one.
                const dateValue =
