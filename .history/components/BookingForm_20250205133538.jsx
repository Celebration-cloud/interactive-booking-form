...
const BookingForm = () => {
  // Use today's date from @internationalized/date for a proper Date object
  const defaultDate = today(getLocalTimeZone());

  // Set the form to validate on change for real-time feedback.
  const {
    control,
    handleSubmit,
    trigger,
    ...
    defaultValues: {
      pickupLocation: "",
      dropoffLocation: "",
      shipmentDate: defaultDate, // a Date object or a compatible value
      cargoWeight: "",
      cargoVolume: "",
      temperature: 0.4,
      fragile: false,
