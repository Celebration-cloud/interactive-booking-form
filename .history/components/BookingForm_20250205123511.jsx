    ...
    <div className="container mx-auto p-4">
      ...
      <Card className="mt-6">
        ...
        <CardFooter className="flex justify-between">
          {activeStep > 0 && (
            <Button color="secondary" variant="solid" onClick={prevStep}>
              Back
            </Button>
          )}
          <ButtonGroup>
            {activeStep < steps.length - 1 && (
              <Button color="primary" variant="solid" onClick={nextStep}>
                Next
              </Button>
            )}
            {activeStep === steps.length - 1 && (
              <Button color="success" type="submit" variant="solid" onClick={handleSubmit(onSubmit)}>
                Confirm Booking
              </Button>
            )}
          </ButtonGroup>
