      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-between my-5 max-sm:hidden">
          {steps.map((step, index) => (
            ...
            >
              <h2
                className={`text-lg font-bold bg-gray-300 text-black px-3 py-1 rounded-full ${activeStep === index || activeStep > ? "bg-green-500 text-foreground-300" : ""}`}
              >
                {index + 1}
              </h2>
              <span
                className={` ${activeStep === index ? "text-green-500" : ""}`}
              >
                {step.label}
              </span>
            </div>
