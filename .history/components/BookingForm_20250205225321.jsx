  ...
  return (
    <div className="min-h-screen p-4">
      ...
      <div className="max-w-7xl mx-auto space-y-5">
        <div className="hidden max-md:flex justify-between my-5 ">
        ...
        <div className="flex justify-between my-5 md:flex-col md:gap-10">
          {steps.map((step, index) => (
            <div
              key={index}
              className="text-center flex flex-col items-center space-y-2 md:flex-row md:gap"
            >
              <h2
                className={`text-lg font-bold bg-gray-300 text-black px-3 py-1 rounded-full ${activeStep === index || activeStep >= index ? "bg-green-500 text-foreground-300" : ""}`}
              >
